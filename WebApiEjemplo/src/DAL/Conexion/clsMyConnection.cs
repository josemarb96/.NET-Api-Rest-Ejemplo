...
namespace DAL.Conexion
{
    public class clsMyConnection
    {
        ...
        public clsMyConnection()
        {
            ...
            //AZURE
            this.server = "wpfsamplejosema.database.windows.net";
            this.dataBase = "WPFSampleJosema";
            this.user = "prueba";
        ...
        public SqlConnection getConnection()
        {
            ...
            try
            {
                ...
                //Azure
                connection.ConnectionString = "Server=tcp:wpfsamplejosema.database.windows.net,1433;Initial Catalog=WPFSampleJosema;Persist Security Info=False;User ID=prueba;Password=iesnervion123.;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
                connection.Open();
            }
            catch (SqlException)
            {
